...
class Friend extends VKPost
{
    public function getMessage()
    {
        ...
        $dataAboutUrFriend = json_decode(file_get_contents($URL = 'https://api.vk.com/method/users.get?user_ids=' . $idUrFriend . '&fields=bdate&v=5.101&access_token=' . config('service.vk.token')));
        ...
        $dataAboutAddFriend = json_decode(file_get_contents($URL = 'https://api.vk.com/method/users.get?user_ids=' . $idAddFriend . '&fields=bdate&v=5.101&access_token=' . config('service.vk.token')));
