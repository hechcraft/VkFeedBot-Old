...
use App\Services\ImageCollection;
    ...
    public function buildServicePayload($message, $matchingMessage, $additionalParameters = [])
    {
        ...
        if ($message instanceof Question) {
            ...
            if ($message->getAttachment() !== null) {
                ...
                } elseif ($attachment instanceof ImageCollection) {
                    $this->endpoint = 'sendMediaGroup';
                    $parameters['media'] = $attachment->toMediaArray();
                    if (isset($parameters['media'][0]) && isset($parameters['media'][0]['caption'])) {
                        $parameters['media'][0]['caption'] = $message->getText();
                    }
